...
TAB2M1  EQU  TAB2-1
        LXI  H,TAB2M1                   ;FIND COMMAND IN TAB2
...
CONIN_ADDR		EQU 0F828h
CONOUT_ADDR		EQU 0F830h
CONSTAT_ADDR 	EQU 0F820h
